/*! function() {
            ...
            Docsify.get(a.router.getFile(n), !1, a.config.requestHeaders).then(function(e) {
                d[n] = function(n, e, t, a) {
                    ...
                    return i.forEach(function(e) {
                        if ("heading" === e.type && e.depth <= a) o = t.toURL(n, {
                            id: r(e.text)
                        }), s[o] = {
                            slug: o,
                            title: e.text,
                ...
                }(n, e, a.router, t.depth), s === ++c && function(e, n, t) {
    ...
    function o(e) {
        ...
        }), t.classList.add("show"), a.classList.add("show"), t.innerHTML = s || '<p class="empty">' + f + "</p>", p.hideOtherSidebarContent && (o.classList.add("hide"), i.classList.add("hide"))
    }
