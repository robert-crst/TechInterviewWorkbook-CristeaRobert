! function() {
        ...
        return r.heading = e.heading = function(e, t) {
            ...
            return t.link = function(e, t, n) {
                ...
                var r = [],
                    ...
                    a = i.str,
                    s = i.config;
                return t = a, H(e) || c._matchNotCompileLink(e) || s.ignore ? (!H(e) && e.startsWith("./") && (e = document.URL.replace(/\/(?!.*\/).*/, "/").replace("#/./", "") + e), r.push(0 === e.indexOf("mailto:") ? "" : 'target="' + l + '"')) : (e === c.config.homepage && (e = "home_page"), e = o.toURL(e, null, o.getCurrentPath())), s.target && r.push('target="' + s.target + '"'), s.disabled && (r.push("disabled"), e = "javascript:void(0)"), s.class && r.push('class="' + s.class + '"'), s.id && r.push('id="' + s.id + '"'), t && r.push('title="' + t + '"'), '<a href="' + e + '" ' + r.join(" ") + ">" + n + "</a>"
            }
        }({
            renderer: e,
            router: l,
    ...
    Pe.prototype.getBasePath = function() {
        ...
        return e = (e = function(e, t) {
            return new RegExp("\\.(" + t.replace(/^\./, "") + "|html)$", "g").test(e) ? e : /\/$/g.test(e) ? e + "home_page" + t : "" + e + t
        ...
        }(e, n.alias) : e, i)) === "/home_page.md" + i && n.homepage || e, e = H(e) ? e : D(r, e), t && (e = e.replace(new RegExp("^" + r), "")), e
